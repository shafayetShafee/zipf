...
def test_alpha():
    ...
    1.0 a maximum word frequency of 600 is used (i.e c = 600)
    and r ranges from 1 to 600).
    """
    max_freq = 600
...
def test_integration():
    """Test the full word count to alpha parameter."""
...
def test_not_csv_error():
    """Test the error handling in case of non-csv file."""
...
def test_file_not_found():
    """Test the error handling in case of missing file."""
    fname='non_existent_file.csv'
    word_counts = Counter()
